...
% Lenguaje Rust para listings (el paquete no trae lexer propio).
\lstdefinelanguage{Rust}{
  morekeywords={as,break,const,continue,crate,dyn,else,enum,extern,false,
...
% Ruta de archivo del repositorio en tipografía monoespaciada con puntos de
% quiebre de línea en /, -, . y _ (evita desbordes con rutas largas). Usa el
% comando \path del paquete url, ya cargado. No emplear en argumentos
% móviles (captions).
\newcommand{\rutarepo}[1]{{\def\UrlBreaks{\do\/\do\-\do\.\do\_}\path{#1}}}
...
\usepackage{fancyhdr}
% fancyhdr exige al menos 13.6pt de alto de encabezado con esta fuente.
