...
En \rutarepo{web/tests/live/}, los archivos de plazos terminados en \texttt{workflow.spec.mjs}, \texttt{permissions.spec.mjs} y \texttt{concurrency.spec.mjs} ejercitan el servidor real. El nuevo \texttt{deadline-reevaluation.spec.mjs} comprueba la transición de calendario seguido, revisión pendiente por fuente y confirmación humana con historia intacta. Sus datos se preparan mediante \rutarepo{scripts/web-deadline-reevaluation.mjs} con activación explícita y raíces independientes de las selecciones históricas fijas. Sus casos aprobados en escritorio y móvil pertenecen a la campaña real de 25 escenarios; la inspección de sus seis capturas no detectó recortes ni desbordamiento. El orquestador de las campañas de navegador es \rutarepo{scripts/web-demo.sh}.
