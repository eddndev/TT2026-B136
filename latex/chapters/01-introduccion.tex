...
consultas documentales persistentes, carga, historial de versiones inmutables,
sellado, verificación y descarga de evidencia de una versión seleccionada.
La clasificación organiza cada documento mediante tipo, categoría y etiquetas
manuales, con revisiones auditadas independientes de su evidencia histórica.
El expediente incorpora un perfil penal manual, revisiones administrativas,
registro inicial de Investigación en el alta completa y cierre o reapertura
organizativos. Completar un perfil pendiente conserva su etapa sin registrar;
las transiciones procesales requieren una extensión propia. El directorio de
participantes mantiene fichas independientes de las cuentas, con valores
manuales, archivo organizativo e historia auditada. El cierre del expediente
impide nuevas mutaciones de esas fichas y de sus documentos. Esta regla no
acredita la condición jurídica del proceso: identidad, identificadores por
tipo, FIREL y duplicidad verificada permanecen pendientes, junto con las
audiencias, los plazos y el calendario. La validación de usabilidad prevista con personal del
