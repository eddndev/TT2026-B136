...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}l L{0.30\linewidth} X@{}}
    ...
    OE-5 & Autenticación diferenciada por rol & Argon2id calibrado a 0.5--1.0 s por intento en el hardware de referencia (m=256 MiB, t=4, p=1); MFA basado en TOTP (RFC 6238 \cite{mraihi2011}) con ventana de tolerancia $\pm$1 período; control de acceso RBAC con cuatro roles diferenciados (Owner, Litigante, Paralegal, Cliente). \\
