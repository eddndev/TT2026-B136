...
La interfaz de navegador, el historial documental, los participantes procesales,
las audiencias, los plazos y el calendario forman parte del desarrollo pendiente.
Su integración permitirá realizar las pruebas de usabilidad previstas con
personal del despacho. La evaluación técnica del flujo implementado se presenta
