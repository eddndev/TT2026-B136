...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}l X l@{}}
    ...
    \texttt{DATABASE\_URL} & Cadena PostgreSQL obligatoria para usuarios y migraciones al ejecutar \texttt{serve}. & --- \\
...
El comando compone identidad multiusuario y el workflow documental: usuarios
en PostgreSQL, sesiones y desafíos en Redis, persistencia documental cifrada,
bitácora encadenada y TSA OpenSSL. Escucha por defecto en
\texttt{127.0.0.1:3000}; exige \texttt{DATABASE\_URL}, \texttt{REDIS\_URL},
\texttt{KEK\_BASE64}, certificado y llave del firmante. Las rutas permiten
bootstrap, login, TOTP o recovery, logout, creación de usuarios y operaciones
documentales protegidas por RBAC. La composición no consulta Cincel y
\texttt{X-Actor} ya no forma parte del contrato.
