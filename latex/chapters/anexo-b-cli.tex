...
despacho-cli [--json]
  ...
  pki [--scripts-dir <DIR>] {init-ca |
      issue --cn <CN> [--purpose <PURPOSE>] |
      revoke --serial <HEX> | gen-crl | show <CERT>}
  credential-trust publish --root-cert <PATH> --crl <PATH>
      --expected-revision <N>
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}l l l X@{}}
    ...
    \texttt{--purpose} & enum & \texttt{partner} & \texttt{partner} o \texttt{participant-}\allowbreak\texttt{declaration}; este último usa el perfil de firma personal interna. \\
    \midrule
