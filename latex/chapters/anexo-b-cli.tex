...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}l X l@{}}
    ...
    \texttt{KEK\_BASE64} & Llave de cifrado de llaves: 32 bytes aleatorios codificados en base64; la leen \texttt{vault} y \texttt{serve}. & --- \\
...
El comando compone el workflow documental con persistencia local cifrada,
bitácora encadenada y la TSA OpenSSL. Escucha por defecto en
\texttt{127.0.0.1:3000}, almacena bajo \texttt{runtime-data} y exige el
certificado y la llave privada del firmante. Las rutas permiten cargar, sellar,
verificar y exportar evidencia, además de comprobar la auditoría; su contrato,
cabeceras y errores se documentan en \texttt{docs/http-api.md}. La composición
no consulta Cincel. \texttt{X-Actor} solo etiqueta la bitácora y no reemplaza
autenticación ni RBAC.
