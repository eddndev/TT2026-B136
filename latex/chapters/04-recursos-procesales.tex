...
Este incremento implementa registro y consulta de recursos declarados. Todavía requiere la asociación específica con audiencias, plazos calculados y alertas, así como el impulso procesal sustentado en un corpus jurídico calificado. Ninguno de sus comandos avanza la etapa, suspende términos o determina elegibilidad. Esas obligaciones permanecen en \rutarepo{docs/procedural-resources-scope.md}; el registro disponible no las sustituye por fechas manuales ni acredita que el flujo completo de recursos esté concluido.
