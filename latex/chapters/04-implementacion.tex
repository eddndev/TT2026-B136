...
El prototipo expone una API Axum multiusuario con alta inicial, autenticación Argon2id, TOTP o recuperación, sesiones revocables, expedientes y asignaciones. Las operaciones documentales exigen un expediente y comprueban el acceso tanto antes de preparar el resultado como al confirmarlo. PostgreSQL persiste usuarios, expedientes, pertenencias, documentos cifrados y una cadena de auditoría compartida; Redis conserva el estado efímero de autenticación. Están implementados carga, listado y detalle de metadatos, búsqueda por nombre, filtro por estado de sellado, anexado e historial de versiones inmutables, sellado local, verificación y exportación de evidencia de una versión explícita. La aplicación de navegador Qadra utiliza Astro y Svelte para presentar estos flujos. Permanecen pendientes la clasificación documental y la actividad procesal completa; la aceptación del producto requiere además validar su integración y usabilidad.
...
El esquema durable se organiza en cuatro migraciones:
\begin{itemize}
