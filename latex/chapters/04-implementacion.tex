...
El registro inicial conserva número de etapa uno y referencia exacta a la revisión administrativa uno. Su huella, instante y autor UUID/correo se obtienen de esa revisión inmutable; una edición posterior no los sustituye. La fecha expresa el registro de la operación, no la fecha acreditada de un acto judicial. Completar un perfil básico o legado conserva la etapa sin registrar. No hay operación HTTP de transición ni de adopción de una etapa anterior.
