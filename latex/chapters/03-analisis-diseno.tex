...
En PostgreSQL, las claves foráneas vinculan cada documento con su expediente y cada asignación con un usuario. La columna \texttt{audit\_events.chain} enlaza los eventos de auditoría, y los privilegios del rol operativo protegen su carácter de solo inserción. Las asignaciones administran acceso a la información; el directorio mantiene raíces y revisiones propias, sin vincular la identidad representada con una cuenta ni deducirla de nombres coincidentes. La figura describe relaciones conceptuales; las claves físicas y las revisiones del directorio se especifican en la \cref{sec:impl-http-participantes}.
...
El expediente reúne título, referencia, creador, documentos y asignaciones. La extensión procesal propuesta incorpora las etapas del CNPP \cite{cnpp2021}, el escrito de acusación para Intermedia y el auto de apertura para Juicio Oral. El directorio organizativo conserva participantes por expediente; transiciones, identidad jurídica, audiencias y plazos requieren modelos propios. Cada documento conserva identidad estable y versiones inmutables con cifrado y evidencia propios. El listado filtra la versión máxima; el historial permite elegir otra sin sustituirla. Anexar exige la versión vigente esperada para rechazar cambios concurrentes incompatibles. Consultas y acciones requieren autorización por expediente y auditoría confirmada.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}X C{0.12\linewidth} C{0.14\linewidth} C{0.14\linewidth} C{0.12\linewidth}@{}}
    ...
    \midrule
    Consultar metadatos e historial & Sí & Sí & Sí & No \\
