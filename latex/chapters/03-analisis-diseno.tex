...
El dominio define identidades y permisos, metadatos de expediente, participantes del directorio, documentos y sus versiones, evidencia criptográfica y eventos de auditoría. Los valores del directorio describen información organizativa; la extensión procesal prevé identidad jurídica, audiencias y etapas. La regla fundamental es que el dominio no importa ninguna otra capa del workspace; utiliza bibliotecas de bajo nivel para tipos, serialización, fechas, errores y manejo de secretos.

{\emergencystretch=2em La capa de aplicación implementa \texttt{Identity\allowbreak Service}, \texttt{Case\allowbreak Service}, \texttt{Case\allowbreak Document\allowbreak Service} y \texttt{Participant\allowbreak Service}, además de los servicios criptográficos y del flujo documental fuera de línea. Sus puertos expresan las dependencias externas, incluidas las fronteras transaccionales \texttt{Case\allowbreak Document\allowbreak Store} y \texttt{Participant\allowbreak Store}. La programación de audiencias y la transición de etapas son casos de uso previstos. La aplicación depende del dominio y no de los adaptadores.\par}
...
El directorio distingue la identidad de la ficha, su revisión y la cuenta autora. La creación fija estado activo y revisión uno; editar, archivar o reactivar añade un sucesor con revisión esperada. El cambio exclusivo de estado conserva los textos actuales dentro de la transacción, evitando sobrescribir una edición concurrente. Lecturas e historia requieren auditoría confirmada. Los homónimos son válidos: nombre y rol manual no demuestran identidad, representación ni permisos. El cierre administrativo impide mutaciones del directorio; no acredita la condición procesal del expediente. El diseño conserva abiertos los criterios de identificación por tipo, órgano/FIREL y duplicidad verificada, conforme a \rutarepo{docs/adr/0021-audited-case-participants.md}.
