...
PostgreSQL proporciona las transacciones y claves foráneas necesarias para relacionar usuarios, expedientes, asignaciones y documentos. El esquema consta de \rutarepo{users}, \rutarepo{cases}, \rutarepo{case_memberships}, \rutarepo{documents}, \rutarepo{audit_events} y \rutarepo{migration_receipts}. El contenido documental cifrado se guarda como bytes y la evidencia capturada como JSONB. El modelo de expediente representa título, referencia y creador; las asignaciones relacionan a los usuarios que pueden acceder a él. La gestión procesal ampliará este modelo con atributos, participantes y relaciones propias de cada procedimiento.
...
El expediente reúne título, referencia, creador, documentos y asignaciones. La extensión procesal propuesta incorpora las etapas del CNPP \cite{cnpp2021}, el escrito de acusación para Intermedia y el auto de apertura para Juicio Oral. Transiciones, participantes, audiencias y plazos se modelarán por separado. Cada documento conserva identidad estable y versiones inmutables con cifrado y evidencia propios. El listado filtra la versión máxima; el historial permite elegir otra sin sustituirla. Anexar exige la versión vigente esperada para rechazar cambios concurrentes incompatibles. Consultas y acciones requieren autorización por expediente y auditoría confirmada.
...
\begin{table}[H]
  \centering
  \caption{Permisos de acceso a las operaciones documentales.}
