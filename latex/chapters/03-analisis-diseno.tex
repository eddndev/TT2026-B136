...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}>{\bfseries}l X@{}}
    ...
    Mitigación & Asignar la Iteración 6, primera de la Fase II, a un Spike Arquitectónico para validar credenciales, red y parseo del token ASN.1 con el sandbox del PSC. \\
