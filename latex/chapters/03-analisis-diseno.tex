...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}L{3.2cm}X@{}}
    ...
    \textbf{Criterio de aceptación} & Dado un contrato firmado, cuando se solicita el sello al PSC, entonces el sistema recibe confirmación de aceptación de la solicitud en menos de 10 segundos y almacena el token RFC 3161 válido en cuanto el PSC lo emite ---de forma inmediata o tras el ciclo de reintento descrito en §3.11.3---; el token debe ser verificable de forma independiente con OpenSSL sin requerir acceso al sistema. \\
    \bottomrule
  \end{tabularx}
\end{table}
