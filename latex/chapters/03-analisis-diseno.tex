...
El expediente se identifica mediante un título, una referencia y su creador, y se relaciona con documentos y asignaciones de usuarios. La extensión procesal propuesta incorpora las etapas del CNPP \cite{cnpp2021} y sus documentos habilitantes: el escrito de acusación para el paso a Intermedia y el auto de apertura para el paso a Juicio Oral. El historial de transiciones, los participantes, las audiencias y los plazos se modelarán como entidades y relaciones propias. La gestión documental deberá añadir consultas de listado, detalle, búsqueda e historial de versiones sobre la carga de versión 1, preservando la evidencia de cada versión.
