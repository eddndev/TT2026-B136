...
Estos mismos scripts son los que ejecuta el prototipo: el adaptador de infraestructura de la autoridad los invoca como subprocesos desde los subcomandos \texttt{pki} de la interfaz de línea de comandos (véase el Anexo~\ref{anexo:cli}), y la suite de pruebas los usa como fixtures reales en directorios temporales, de modo que las pruebas ejercitan exactamente la autoridad de producción.
