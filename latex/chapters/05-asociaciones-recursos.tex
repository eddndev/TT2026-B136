...
Tres escenarios distintos de navegador real aprobaron: Owner en escritorio, Litigator en móvil y permisos con Paralegal y Client. La primera campaña aprobó los dos flujos de escritura y detectó un error en la navegación del guion de Client; la repetición del recorrido corregido aprobó en 274.304 segundos, incluidos los preparativos. No se alteraron las actividades ni se duplicaron sus avisos. El cierre global en CI permanece pendiente. Las campañas de API y navegador conservan resultados separados y no equivalen a una regresión global. Tampoco se acreditan corpus jurídico, activación automática, creación contextual de audiencias, entrega externa de avisos o usabilidad con personas. La matriz del \cref{sec:matriz-asociaciones-recursos} distingue esas fronteras.
