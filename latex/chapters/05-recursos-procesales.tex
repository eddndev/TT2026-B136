...
El corte local del 19 de septiembre de 2026 verifica por separado dominio, aplicación, transporte, almacenamiento e interfaz del registro descrito en la \cref{sec:impl-recursos-declarados}. El informe \rutarepo{docs/verification-report.md} conserva la procedencia y el alcance de las ejecuciones. Los resultados siguientes no constituyen una regresión global de una única cabeza publicada ni una aceptación completa con navegador y servidor reales.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}L{2.9cm} L{2.7cm} X@{}}
    ...
    Cliente JavaScript & 4 de valores y 5 de API aprobadas & Validación de comandos, respuestas y recibos antes de consumirlos en la interfaz. \\
