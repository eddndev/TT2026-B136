...
La cápsula conserva las huellas de valores, fuentes y operación de los hechos, o las huellas de valores y operación del resultado de audiencia. El dominio no recalcula ni acredita estas huellas. El servicio de aplicación resuelve fuentes persistidas, verifica recibos y autorización antes de construir el material. La calificación de elegibilidad jurídica mantiene su desarrollo pendiente. La comprobación de identidad entre objetos no demuestra por sí misma existencia persistida ni aplicabilidad jurídica.
