...
La \cref{tab:matriz-resumen} resume la distribución de las 383 funciones por crate y la \cref{tab:matriz-pruebas} presenta la matriz completa: una fila por archivo o módulo de prueba, agrupadas por crate. La columna \textbf{N} indica el número de funciones de prueba del archivo; la suma de la columna es 383. Las rutas se abrevian respecto de la raíz de cada crate: \texttt{src/} señala pruebas unitarias embebidas en el módulo (\texttt{\#[cfg(test)]}) y \texttt{tests/} señala binarios de prueba de integración. En la fila del stub del proveedor de sellado, la anotación $(+1)$ corresponde a la única prueba ignorada.

\begin{table}[H]
  \centering
  \caption{Distribución de las 383 funciones de prueba por crate. El conteo de integración de \texttt{infrastructure} incluye la prueba ignorada.}
  ...
  \begin{tabularx}{\linewidth}{@{}X R{3.4cm} R{3.8cm} R{2.0cm}@{}}
    ...
    \texttt{application} & 39 & 43 & 82 \\
    \texttt{infrastructure} & 86 & 87 & 173 \\
    \texttt{bin} & 3 & 52 & 55 \\
    \texttt{web} & 1 & 3 & 4 \\
    \midrule
    Total & 198 & 185 & 383 \\
...
\begin{longtable}{@{}L{0.27\linewidth}C{0.05\linewidth}L{0.13\linewidth}L{0.45\linewidth}@{}}
  ...
  \texttt{src/crypto/\allowbreak{}timestamp.rs} & 3 & Unit. & \texttt{each\_rejection\_cause\_is\_reported\_explicitly}\newline
    \texttt{ports\_are\_object\_safe\_and\_round\_trip} \\
  \midrule
  \multicolumn{4}{@{}l@{}}{\textbf{Crate \texttt{application}} --- 39 unitarias en \texttt{src/} y 43 en \texttt{tests/}, con dobles de los puertos} \\
  \midrule
  ...
  \midrule
  \multicolumn{4}{@{}l@{}}{\textbf{Crate \texttt{infrastructure}} --- 86 unitarias en \texttt{src/} y 87 de integración en \texttt{tests/} (una ignorada)} \\
  \midrule
  ...
  \midrule
  \multicolumn{4}{@{}l@{}}{\textbf{Crate \texttt{web}} --- 1 unitaria en \texttt{src/} y 3 de contrato en \texttt{tests/}} \\
  \midrule
  ...
  \texttt{tests/document\_api.rs} & 3 & Integr. & \texttt{the\_document\_routes\_expose\_the\_complete\_workflow}\newline
    \texttt{upload\_requires\_actor\_and\_document\_name\_headers}\newline
    \texttt{an\_unknown\_document\_maps\_to\_not\_found} \\
\end{longtable}
\endgroup

El crate \texttt{web} conserva la prueba de \texttt{/healthz} y añade tres pruebas de contrato sobre el workflow inyectado. Sesiones, RBAC y persistencia PostgreSQL/Redis permanecen fuera de este corte; el repositorio local cifrado se prueba en \texttt{infrastructure}.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{@{}l R{2.6cm} R{2.2cm} R{2.4cm} X@{}}
    ...
    \midrule
    \texttt{domain} & 937 & 974 & 96.2\,\% & $\geq$ 90\,\% \\
    \texttt{application} & 1\,488 & 1\,561 & 95.3\,\% & $\geq$ 90\,\% \\
    \texttt{infrastructure} & 2\,009 & 2\,151 & 93.4\,\% & $\geq$ 90\,\% \\
    \texttt{bin} & 833 & 1\,008 & 82.6\,\% & sin umbral (informativo) \\
    \texttt{web} & 168 & 223 & 75.3\,\% & sin umbral (informativo) \\
    \midrule
    Total del workspace & 5\,435 & 5\,917 & 91.9\,\% & --- \\
    \bottomrule
  \end{tabularx}
\end{table}
