...
const LOOKUPS: &[(&str, &str, &[&str])] = &[
    (
        "alert_schedule",
        "alert_schedule_due",
        &["status", "trigger_seconds", "trigger_nanos", "id"],
    ),
    (
        "alert_schedule",
        "alert_schedule_subject",
        &["kind", "subject_id", "recipient"],
    ),
    (
        "alert_notifications",
        "alert_inbox_order",
        &["recipient", "created_seconds", "created_nanos", "id"],
    ),
    (
        "alert_email_outbox",
        "alert_outbox_due",
        &["status", "next_seconds", "next_nanos", "id"],
    ),
];
