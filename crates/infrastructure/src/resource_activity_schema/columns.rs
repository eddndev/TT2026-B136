...
pub(super) fn expected(table: &str) -> &'static [(&'static str, &'static str, bool)] {
    match table {
        ...
        "case_resource_activity_association_revisions" => &[
            ...
            ("status", "text", true),
            ("reason", "text", false),
            ("resource_revision", "bigint", true),
            ("resource_capture_digest", "bytea", true),
            ("act_id", "uuid", false),
            ("act_revision", "bigint", false),
            ("act_resource_revision", "bigint", false),
            ("act_capture_digest", "bytea", false),
            ("target_kind", "text", true),
            ("hearing_id", "uuid", false),
            ("hearing_revision", "bigint", false),
            ("hearing_submission_digest", "bytea", false),
            ("deadline_id", "uuid", false),
            ("deadline_revision", "bigint", false),
            ("deadline_capture_digest", "bytea", false),
            ("selection_canonical", "bytea", true),
            ...
            ("recorded_resource_revision", "bigint", true),
            ("recorded_resource_capture_digest", "bytea", true),
