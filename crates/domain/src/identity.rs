...
pub enum Permission {
    ReadDeadlineInputs,
    ReadProceduralFact,
    ManageProceduralFact,
    ReadJudicialCalendar,
    ManageJudicialCalendar,
    ReadHearingResult,
    ManageHearingResult,
    ReadHearing,
    ManageHearing,
    ReadCaseStage,
    ManageCaseStage,
    ReadCaseAdministration,
    ManageCaseAdministration,
    ReadParticipant,
    ManageParticipant,
    ReadDocument,
    CreateDocument,
