...
\begin{frame}{Qué demuestra este corte}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.24\textwidth}\metricbox{Pruebas aprobadas}{382}{tinta}\end{column}
    \begin{column}{0.24\textwidth}\metricbox{Cobertura global}{91.9\%}{verde}\end{column}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.53\textwidth}
      ...
      \begin{itemize}
        ...
        \item Persistencia local cifrada y evidencia interoperable.
      \end{itemize}
    \end{column}
    \begin{column}{0.43\textwidth}
      ...
      \begin{itemize}
        ...
        \item Sesiones, RBAC, persistencia productiva y UI siguen pendientes.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Resultados de pruebas y cobertura}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.63\textwidth}
      \coveragebar{domain}{96.2}{937 / 974 líneas}
      \coveragebar{application}{95.3}{1,488 / 1,561 líneas}
      \coveragebar{infrastructure}{93.4}{2,009 / 2,151 líneas}
      \coveragebar{bin}{82.6}{833 / 1,008 líneas; informativo}
    \end{column}
    \begin{column}{0.33\textwidth}
      \begin{block}{Suite completa}
        \centering
        {\fontsize{28}{30}\selectfont\bfseries 383}\par
        {\small funciones descubiertas}\par
        \vspace{0.3cm}
        {\color{verde}\bfseries 382 aprobadas}\par
  ...
  \end{columns}
  \vspace{0.2cm}
  {\scriptsize\color{gris}El umbral del 90\% aplica a los tres crates con lógica criptográfica; \texttt{web} reporta 75.3\% informativo. La prueba ignorada conserva la sonda externa, fuera de la evidencia actual por inestabilidad y costo no transparente.}
\end{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.52\textwidth}
      ...
      \begin{enumerate}
        ...
        \item Levantar la aplicación HTTP en un puerto efímero.
...
\begin{frame}{Límites abiertos del corte}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.31\textwidth}
      \begin{block}{Web y persistencia}
        \small API y persistencia local cifrada entregadas. Faltan sesiones, roles, PostgreSQL/Redis y UI.
      \end{block}
    \end{column}
  \end{columns}
  ...
  \begin{alertblock}{Interpretación}
    \small El núcleo y el flujo HTTP local están implementados y probados. La TSA local cierra la demostración técnica; el frente restante es identidad, autorización, persistencia productiva y UI.
  \end{alertblock}
\end{frame}
...
\begin{frame}{Resultado del avance}
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.60\textwidth}
      {\fontsize{19}{23}\selectfont\bfseries\color{tinta}
        La aplicación ya integra el núcleo sin trasladar criptografía ni reglas de dominio a la capa web.\par}
      \vspace{0.35cm}
  ...
  \end{columns}
  \vspace{0.42cm}
  \centering{\scriptsize\color{gris}\texttt{docs/verification-report.md} \quad | \quad \texttt{scripts/demo.sh} \quad | \quad \texttt{scripts/api-demo.sh}}
\end{frame}
