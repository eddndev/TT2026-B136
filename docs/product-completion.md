...
El núcleo V2 está publicado en la PR 34, todavía en borrador, y no forma
parte de la entrega integrada por PR 33. El incremento de preparación técnica
tiene una campaña propia de 2442 pruebas Rust aprobadas y controles globales
aprobados; no reutiliza las cifras de la base como evidencia nueva. Siguen
pendientes la persistencia V2 con reconstrucción exacta, el despacho y trabajador
durables, el contrato HTTP V2 y sus flujos Qadra.
